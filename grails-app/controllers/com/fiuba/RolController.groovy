...
class RolController {
    ...
    def save(Rol rolInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'rolInstance.label', default: 'Rol'), rolInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'rolInstance.label', default: 'Rol'), params.id])
                redirect action: "index", method: "GET"
            }
