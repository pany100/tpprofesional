	...
	<body>
		...
		<div id="show-rol" class="content scaffold-show" role="main">
			...
			<ol class="property-list rol">
				...
				<g:if test="${rolInstance?.acciones}">
				<li class="fieldcontain">
					<span id="acciones-label" class="property-label"><g:message code="rol.acciones.label" default="Acciones" /></span>
					
						<g:each in="${rolInstance.acciones}" var="a">
