	...
	<body>
		...
		<div id="show-accion" class="content scaffold-show" role="main">
			...
			<ol class="property-list accion">
				...
				<g:if test="${accionInstance?.nombre}">
				<li class="fieldcontain">
					<span id="nombre-label" class="property-label"><g:message code="accion.nombre.label" default="Nombre" /></span>
					
						<span class="property-value" aria-labelledby="nombre-label"><g:fieldValue bean="${accionInstance}" field="nombre"/></span>
